#ifndef CAFFE_MANUAL_PRIORBOX_LAYER_HPP_
#define CAFFE_MANUAL_PRIORBOX_LAYER_HPP_
...
class ManualPriorBoxLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides PriorBoxParameter manual_prior_box_param,
   *     with ManualPriorBoxLayer options:
   ...
   */
  explicit ManualPriorBoxLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ManualPriorBox"; }
...
#endif  // CAFFE_MANUAL_PRIORBOX_LAYER_HPP_
